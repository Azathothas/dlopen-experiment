/* The one thing version-compat.c needs from foreign-dlopen.c.
 *
 * They are separate translation units linked into the same foreign-dlopen.so.
 * ELF parsing lives in foreign-dlopen.c and stays there -- a second ELF reader
