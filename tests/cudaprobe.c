/* T6.1 -- foreign-load a PROPRIETARY, CLOSED-SOURCE host driver and drive real
 * hardware through it.
 *
 ...
 *   dlopen("libdxcore.so")     a BARE SONAME opened by the foreign object
 *                              itself, which foreign-dlopen deliberately does
